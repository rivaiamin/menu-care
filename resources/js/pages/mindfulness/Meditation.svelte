<script lang="ts">
    ...
    import { PlayCircle, ArrowLeft, Loader2, Video, Headphones } from 'lucide-svelte';
    ...
    onMount(async () => {
        try {
            ...
            error = 'Gagal memuat konten meditasi';
            loading = false;
            console.error('Error loading meditation content:', err);
        }
    });
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-muted-foreground mt-2">
                    Video dan audio meditasi singkat untuk menenangkan pikiran
                </p>
            </div>
            ...
            <Tabs bind:value={activeTab}>
                ...
                <TabsContent value="audios" class="mt-6">
                    {#if audios.length === 0}
                        <Card>
                            <CardContent class="pt-6">
                                <p class="text-muted-foreground">Belum ada audio meditasi yang tersedia untuk kategori Anda.</p>
                            </CardContent>
                        </Card>
                    {:else}
                        <div class="grid gap-6 md:grid-cols-2">
